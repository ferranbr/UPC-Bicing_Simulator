...
This is a C++ university project for the PRO2 (Object-Oriented Programming) course at UPC-FIB. The program simulates a "Bicing" (bike-sharing) management system with a unique core feature: the stations are organized in a hierarchical **binary tree structure**.
